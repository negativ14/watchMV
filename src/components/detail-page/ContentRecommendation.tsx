...
export default async function ContentRecommendation({
  ...
  //   const url = `${BASE_URL}/${contentType}/${id}/recommendations?language=en-US&page=1`;
  const url =
    "https://api.themoviedb.org/3/movie/640146/recommendations?language=en-US&page=1";
  return (
    <div className="border-b border-foreground/30 border-dashed">
      <div className="max-w-7xl mx-auto overflow-x-scroll scroll-hide">
        <List title="Recommendation" url={url} />
